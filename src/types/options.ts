 ...
 * @prop coalesceDelegateLifecycle - when true, emit at most one will/did add/remove hook per event key per delegate lifecycle episode on this bus
 */
export interface Options {
  ...
  verbose?: boolean;
  coalesceDelegateLifecycle?: boolean;
}